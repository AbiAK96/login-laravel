    ...
    <div class="d-flex">
        ...
        <div class="dropdown d-inline-block">
            <button type="button" class="btn header-item waves-effect" id="page-header-user-dropdown"
                ...
                <img class="rounded-circle header-profile-user" src="{{ isset(Auth::user()->photo) ? asset(Auth::user()->photo) : asset('build/images/users/user-dummy-img.jpg') }}"
                    alt="Header Avatar">
...
<div class="modal-dialog modal-xl">
    <div class="modal-content">
        <div class="modal-header">
            <h5 class="modal-title" id="newContactModalLabel">Update Profile - {{Auth::user()->registration_id}}</h5>
